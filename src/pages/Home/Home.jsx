...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="text-center mt-7 2xl:mt-15">
        <h2 className="text-4xl md:text-5xl font-bold flex justify-center items-center text-stone-700">
          Trending Apps <IoMdTrendingUp color="#9f62f2" size={65} />
        </h2>
        <p className="text-sm md:text-xl text-[#627382] pb-8 mt-5">
          Explore All Trending Apps on the Market developed by us
        </p>
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pb-10 p-2 2xl:p-0">
